...
CREATE TABLE `booking_seats` (
  ...
  `seats_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_bookingSeats_booking` (`booking_id`),
  KEY `fk_bookingSeats_seat` (`seat_id`),
  CONSTRAINT `fk_bookingSeats_booking` FOREIGN KEY (`booking_id`) REFERENCES `booking` (`id`),
...
INSERT INTO `booking_seats` VALUES (1,5,NULL,1),(2,5,NULL,2);
